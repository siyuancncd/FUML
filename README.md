...
2. **Extending FUML to more practical scenarios and problems**, such as missing view problems, multi-label classification problems, long-tail classification problems, adversarial attack problems, streaming multimedia scenarios, semi-supervised scenarios, and unsupervised scenarios. (If you are interested in collaborating with me on these topics, please feel free to contact me at the email below.)
3. **Expanding the theoretical boundaries**. Several issues remain unresolved: a) FUML lacks uncertainty calibration; b) FUML stands for a deterministic pipeline, which may result in inaccurate uncertainty estimations in certain scenarios. (If you are interested in collaborating with me on these topics, please feel free to contact me at the email below.)
